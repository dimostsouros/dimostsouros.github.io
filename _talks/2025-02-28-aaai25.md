...
Additionally, we present a generate-and-test approach that can be used with any classifier, to generate the ground constraints on the fly. %, applicable to models where interpretable decision rules cannot be extracted. 
